...
def start_round():
    ...
    if not game_active:
        ...
        dx_ratio = math.sqrt(1 - dy_ratio**2)
    ...
    while True:
        ...
        if game_active:
            ...
            if ball.xcor() > 390:
                ...
                high_score_display.clear()
                high_score_display.write("High Score: {}".format(high_score), align="center", font=("Arial", 14, "normal"))
                bounce_display.clear()
            ...
            if (
                (ball.xcor() > 340)
                and (ball.xcor() < 350)
                and (ball.ycor() < rightpaddle.ycor() + 50 and ball.ycor() > rightpaddle.ycor() - 50)
            ):
                ball.setx(340)
                speed *= 1.05
                ...
                bounce_count += 1
                bounce_display.clear()
                bounce_display.write("Bounces: {}".format(bounce_count), align="center", font=("Arial", 16, "normal"))

            # Left paddle collision
            if (
                (ball.xcor() < -340)
                and (ball.xcor() > -350)
                and (ball.ycor() < leftpaddle.ycor() + 50 and ball.ycor() > leftpaddle.ycor() - 50)
            ):
                ball.setx(-340)
                speed *= 1.05
                dx_ball = speed * math.sqrt(1 - dy_ratio**2)
